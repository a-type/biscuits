...
export interface GeneratedHooks<Presence, Profile> {
  ...
  usePlaylist(id: string, config?: { skip?: boolean }): Playlist | null;
  usePlaylistUnsuspended(
    id: string,
    config?: { skip?: boolean },
  ...
  useAllPlaylistsUnsuspended: <Config extends HookConfig<PlaylistFilter>>(
    config?: Config & { limit?: number },
  ) => { data: Playlist[]; status: QueryStatus };
  useAllPlaylistsPaginated: <
    Config extends HookConfig<PlaylistFilter> & {
      pageSize?: number;
      suspend?: false;
    },
  >(
