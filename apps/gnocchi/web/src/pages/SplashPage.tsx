	...
	return (
		<div className="bg-white color-black flex flex-col items-stretch">
			...
			<Content className="bg-primary-light">
				<DemoGrid>
					<TitleWrap>
						<h2 className="[font-family:'Londrina_Outline',_sans-serif] font-500 text-[6vmax] color-black mb-20dvh">
							{APP_NAME}
						</h2>
			...
			<Content
				className={classNames(
					'bg-primary border-t-20dvh border-b-20dvh border-solid border-primary-light',
					'theme-leek',
				)}
				ref={upgradeSectionRef}
			>
				<DemoGrid className="mt-20dvh">
			...
			<Content
				className={classNames(
					'theme-leek',
					'important:bg-primary-light pb-20dvh',
				)}
			>
