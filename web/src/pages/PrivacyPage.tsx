  ...
  return (
    <PageContent>
      ...
      <ul>
        ...
        <li>
          <p>
            <strong>Plan</strong> refers to a subscription to the Service, which
            allows multiple Accounts to collaborate and share data across
            devices.
          </p>
        </li>
        <li>
        ...
        <li>
          <p>
            <strong>Application</strong> refers to any software program provided
            by the Company (often referred to as "Biscuits Apps").
          </p>
        </li>
        <li>
          <p>
            ...
            this Agreement) refers to Biscuits.
          </p>
        </li>
        <li>
          <p>
      ...
      <ul>
        ...
        <li>
          ...
          Account's Plan within the Service.
        </li>
        <li>
