/* eslint-disable */
// Generated by Wrangler by running `wrangler types src/worker-configuration.d.ts` (hash: 6583cd37d0cc76ba94cb4ad2ca10dec2)
...
declare namespace Cloudflare {
	...
	interface Env {
		DOMAIN_ROUTES: KVNamespace;
		DEPLOYED_ORIGIN: string;
		UI_ORIGIN: string;
		VERDANT_SECRET: string;
		SESSION_SECRET: string;
		SHARE_PLAN_PRICE_ID: string;
		...
		GNOCCHI_HUB_ORIGIN: string;
		POST_HUB_ORIGIN: string;
		WISH_WASH_HUB_ORIGIN: string;
		ENVIRONMENT: string;
		VAPID_PUBLIC_KEY: string;
		VAPID_PRIVATE_KEY: string;
		VERDANT_LIBRARY: DurableObjectNamespace<
			import('./src/index.ts').VerdantLibrary
		>;
		USER_FILES: R2Bucket;
		CORE_DB: D1Database;
